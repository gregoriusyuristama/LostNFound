...
//    let imageURL: URL?
    ...
    func toDTO() throws -> ItemLost.DTO{
        ...
        return ItemLost.DTO(id: id, item_name: itemName, category: category, location_found: locationFound, current_location: currentLocation, date_found: dateFoundString, image: imageURL.absoluteString, desc: desc, last_modified: lastModifiedString, person_in_charge: personInCharge, phone_number: phoneNumber, found_item_id: idFoundItem)
    }
}
...
extension ItemLost {
    struct DTO: Codable {
        ...
        func toDomain() throws -> ItemLost {
            ...
            return ItemLost(id: id, itemName: item_name, category: category, locationFound: location_found, currentLocation: current_location, dateFound: dateFound, desc: desc, lastModified: last_modified, personInCharge: person_in_charge, phoneNumber: phone_number, idFoundItem: found_item_id)
        }
    }
}
