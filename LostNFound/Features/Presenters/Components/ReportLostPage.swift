        ...
        VStack {
            ...
            SubmitButton(doSubmit: {
                if checkForm() {
                    ...
                    if let imgData = selectedImage?.jpegData(compressionQuality: 0.1){
...
struct ReportLostPage_Previews: PreviewProvider {
